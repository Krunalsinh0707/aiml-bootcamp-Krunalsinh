...
print(
    s1
)  # while printing single object it will call __str__ method and print the string representation of the object
print(
    students
)  # while printing list of objects it will call __repr__ method and print the string representation of the object
